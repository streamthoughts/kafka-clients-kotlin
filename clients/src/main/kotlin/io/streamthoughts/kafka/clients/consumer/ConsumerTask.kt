...
class ConsumerTask<K, V>(
    ...
    companion object {
        private val Log = loggerFor(ConsumerTask::class.java)
    }
    ...
    enum class ConsumerState {
        CREATED, STARTING, RUNNING, PAUSED, PARTITIONS_ASSIGNED, PARTITIONS_REVOKED, PENDING_SHUTDOWN, SHUTDOWN
    }
